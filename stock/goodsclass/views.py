...
#         if self.request.user:
#             if id is None:
#                 return ShopeeCategory.objects.filter(openid=self.request.auth.openid)
#             else:
#                 return ShopeeCategory.objects.filter(openid=self.request.auth.openid, id=id)
#         else:
#             return ShopeeCategory.objects.none()
#
#     def get_serializer_class(self):
