  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: 'orderavailable',
              name: 'orderavailable',
              component: () => import('pages/order/orderavailable.vue')
            },
            {
              path: 'ordermessage',
              name: 'ordermessage',
              component: () => import('pages/order/ordermessage.vue')
            }
          ]
        },
        {
          ...
          children: [
            {
              ...
              component: () => import('pages/store/storemanagement.vue')
            },
            {
              path: 'globalproductlist',
              name: 'globalproductlist',
              component: () => import('pages/store/globalproductlist.vue')
            },
            {
              path: 'productlist',
              name: 'productlist',
              component: () => import('pages/store/productlist.vue')
            },
            {
              path: 'productpackage',
              name: 'productpackage',
              component: () => import('pages/store/productpackage.vue')
            }
          ]
        },
        {
          ...
          children: [{
            ...
            },
            {
              path: 'supplier',
              name: 'supplier',
              component: () => import('pages/inbound/supplier.vue')
            },
          ]
        },
        {
        ...
        },
        {
          ...
          path: 'goodsdraftbox',
          name: 'goodsdraftbox',
          component: () => import('pages/goods/draftbox')
        },
        {
          path: 'fetchbox',
          component: () => import('pages/fetchbox/fetchbox.vue'),
          children: [
            {
              path: 'fetchlist',
              name: 'fetchlist',
              component: () => import('pages/fetchbox/fetchlist.vue')
            }, {
              path: 'arealist',
              name: 'arealist',
              component: () => import('pages/fetchbox/arealist.vue')
            }
          ]
        },
        {
