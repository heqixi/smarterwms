      ...
      <q-scroll-area class="fit" style="overflow-y: auto">
        <q-list>
          ...
          <q-item
            ...
            @click="linkChange('storemanagement')"
            v-ripple
            exact
            :active="link === 'storemanagement' && link !== ''"
            :class="{ 'my-menu-link': link === 'storemanagement' && link !== '' }"
          >
            <q-item-section avatar
            ><q-icon name="storefront"
            /></q-item-section>
            <q-item-section>{{ $t("menuItem.store") }}</q-item-section>
          </q-item>
          <q-item
            clickable
            :to="{ name: 'orderlist' }"
            @click="linkChange('orderlist')"
            v-ripple
            exact
            :active="link === 'orderlist' && link !== ''"
            :class="{ 'my-menu-link': link === 'orderlist' && link !== '' }"
          >
            <q-item-section avatar
          ...
          <q-expansion-item group="somegroup" icon="shop_two" :label="$t('menuItem.goods') " header-class="text-teal">
            <q-item
              clickable
              :to="{ name: 'goodsdraftbox' }"
            ...
            <q-item
              ...
              <q-item-section>Shopee在线产品</q-item-section>
            </q-item>
          </q-expansion-item>
<!--          <q-item-->
<!--            clickable-->
...
<!--          </q-item>-->
          <q-item
              clickable
              :to="{ name: 'fetchlist' }"
              @click="linkChange('fetchlist')"
              v-ripple
              exact
              :active="link === 'fetchlist' && link !== ''"
              :class="{ 'my-menu-link': link === 'fetchlist' && link !== '' }"
          >
            <q-item-section avatar><q-icon name="collections" /></q-item-section>
            <q-item-section>{{ $t("menuItem.fetchbox") }}</q-item-section>
          </q-item>
          <q-item
            clickable
            :to="{ name: 'company' }"
