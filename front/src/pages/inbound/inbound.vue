<template>
  <q-page class="flex flex-top content-start">
<template>
  <div class="q-pa-md">
    <div class="q-gutter-y-md" style="max-width: 100%">
      ...
      >
        ...
        <transition appear enter-active-class="animated zoomIn">
          <q-route-tab name="sortstock" :label="$t('inbound.instock')" icon="img:statics/inbound/sortstock.png" :to="{ name: 'sortstock' }" exact/>
        </transition>
        <transition appear enter-active-class="animated zoomIn">
